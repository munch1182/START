<template>
    <div class="relative" :class="containerClass">
        <!-- 加载状态 -->
        <div v-if="state.loading" class="absolute inset-0 flex flex-col items-center justify-center bg-white bg-opacity-90 z-10 rounded-lg p-6">
        ...
        <!-- 错误状态 -->
        <div v-else-if="state.error" class="absolute inset-0 flex flex-col items-center justify-center bg-white bg-opacity-90 z-10 rounded-lg p-6">
            <slot name="error" :error="state.error">
                ...
                <button @click="$emit('retry')" class="mt-4 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">重试</button>
            </slot>
        </div>

        <!-- 空状态 -->
        <div v-else-if="state.isEmpty" class="absolute inset-0 flex flex-col items-center justify-center bg-white bg-opacity-90 z-10 rounded-lg p-6">
        ...
        <!-- 成功状态 -->
        <div v-else-if="showSuccess" class="absolute inset-0 flex flex-col items-center justify-center bg-white bg-opacity-90 z-10 rounded-lg p-6">
